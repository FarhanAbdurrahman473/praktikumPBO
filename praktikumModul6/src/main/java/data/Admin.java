...
import static main.LibrarySystem.*;
...
public class Admin extends User implements iMenu {
    ...
    public boolean checkUsername(String username) throws IllegalAdminAccess {
        if (!username.equals("admin")) {
            throw new IllegalAdminAccess("Access Denied! This action requires admin privileges.");
        }
        return true;
    }
